           ...
           <section className="bg-[#ffffff] py-10">
                <div className="max-w-screen-xl mx-auto flex justify-between items-center">
                    ...
                    <div className="flex gap-6">
                        ...
                        <Image src="/images/ant-design_instagram-outlined.png" alt="instagram" width={24} height={24}className="w-6 h-6 " />
                        <Image src="/images/ant-design_twitter-outlined.png" alt="twitter" width={24} height={24} className="w-6 h-6 " />
                    </div>
                </div>
            </section>
