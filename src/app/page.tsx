...
//         <p className="text-lg mt-4">Explore the best products at unbeatable prices.</p>
//         <button className="mt-6 bg-blue-500 text-white px-4 py-2 rounded">Shop Now</button>
//       </section>
...
import DesktopView from './components/ecommerce_desktop';
